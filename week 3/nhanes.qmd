...
probability_has_diabetes   # P(B): Probability of having diabetes
probability_old_diabetes <- mean(nhanes_data$DIQ010 == "Has Diabetes" & nhanes_data$age_bracket =="old")  # P(A|B): Probability of being over 40 given diabetes
probability_old <- mean(nhanes_data$age_bracket == "old") # P(A): Overall probability of being over 40
old_has_diabetes <- probability_old_diabetes * probability_has_diabetes / probability_old
# Apply Bayes' theorem
